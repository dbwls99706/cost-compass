...
![본부 목록](docs/screenshots/04-divisions.png)
*5개 본부를 실제 원가 내림차순으로 정렬해 비교한다.*

![본부 상세](docs/screenshots/05-division-detail.png)
*본부 단위 KPI와 월별 추이, 카테고리 비중, 소속 프로젝트 목록까지 한 번에 확인한다.*
...
- 본부 드릴다운 (KPI + 차트 2종 + 소속 프로젝트 Table)
...
| 2 | 대시보드, 프로젝트, 본부 화면 | KPI 4종, 차트 5종, 프로젝트 목록/상세, 본부 드릴다운, CSV 내보내기 |
